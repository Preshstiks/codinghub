...
const MainBody = () => {
  ...
  return (
    <div className="mainbody border-b border-neutral-300 px-[5%] pb-12">
      <div className="flex gap-4 pt-12 pb-5">
        <Image src="/trend-icon.png" width={25} height={20} />
        <h1 className="font-medium">Trending on CodingHub</h1>
      </div>
      <div>
        <div className="grid md:grid-cols-3 sm:gap-0 gap-4 sm:grid-cols-2">
          <div className="flex gap-6">
            ...
            <div>
              ...
              <h1 className="font-[800] text-sm pt-2 pb-1">
