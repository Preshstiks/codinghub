...
const MainBody2 = () => {
  return (
    <div className="static z-10">
      <div className="mdd:mainbody2 flex px-[5%] md:flex-row flex-col-reverse gap-5 justify-between relative mdd:py-20 mdd:border-b mdd:border-neutral-300">
        ...
        <div className="mdd:sticky static z-10 top-0 h-[100%] mdd:w-auto w-[100%]">
          ...
          <div>
            <div className="border-neutral-300 border-b">
              <div className="md:grid md:grid-cols-3 flex flex-wrap gap-3">
